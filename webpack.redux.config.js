...
module.exports={
    ...
    plugins: [//注意这是一个数组..
        ...
        new ExtractTextPlugin("./redux_example/style.css"),
    ...
    //入口文件配置
    entry: {
        './redux_example/app':'./redux_example/main/main.js',
    },
    //产出文件配置
    output:{
    ...
    module: {
        ...
        loaders: [
            ...
            // 检测CSS后缀使用插件  
            { test: /\.css$/, loader: ExtractTextPlugin.extract('./redux_example/style', 'css')},
            ...
            //sass编译
            { test: /\.scss$/, loader: ExtractTextPlugin.extract('./redux_example/style', 'css!sass')},
        ],
    },
    resolve: {
